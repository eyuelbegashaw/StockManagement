...
const Consignee = ({consigneeType}) => {
    const [inputs , setInputs] = useState({
        code:"" , remark:"" , type: consigneeType ,
    ...
    useEffect( ()=> {
        const fetchData = async () => {
            const response = await consigneeAPI.readData();
    ...
    const handleSubmit = async (e) =>
    {
        ...
        else
        {
            ...
            if(edit)
            {
                await consigneeAPI.updateData(newData.code , newData).then(()=> console.log("edit success"));
            ...
            else
            {
                ...
                const res = await consigneeAPI.createData(newData).then(()=>{console.log("successfully added")});
    ...
    const handleDelete = async (code) => {
        await consigneeAPI.deleteData(code);
